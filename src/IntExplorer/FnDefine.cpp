...
static bool SendToServer( SimpleDialog* SD )
{
...
static bool ADI_Txt( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* y1,
...
//--------------edit box---------------
//#edit[%...](%...[...],{%var_name})
static bool ADI_Edit( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* y1,
    int NActive, char** Active, int NParam, char** Param, char* /*param*/ )
{
...
//#ping[%...](%...[...],IP_DWORD)
static void ProcPing( sicExplorer* /*SXP*/, void* PData, int /*size*/ )
{
...
static bool ADI_Ping( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* /*x1*/, int* /*y1*/,
    int /*NActive*/, char** /*Active*/, int NParam, char** Param, char* /*param*/ )
{
	if (!NParam)
	{
...
static void CBB_Process( sicExplorer* SXP, void* Data, int /*size*/ )
{
...
static bool ADI_Combo( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* /*y1*/,
    int NActive, char** Active, int NParam, char** Param, char* /*param*/ )
{
...
static void CBB_Process2( sicExplorer* SXP, void* Data, int /*size*/ )
{
...
static void CBB_Close2( sicExplorer* /*SXP*/, void* Data, int /*size*/ )
{
	ADI_Combo_Data2* ADCD = (ADI_Combo_Data2*) Data;
...
static bool ADI_Combo2( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* /*y1*/,
    int NActive, char** Active, int NParam, char** Param, char* /*param*/ )
{
	if (SXP->CurWPosition > SXP->NWindows)return true;
	OneSicWindow* OSW = SXP->Windows[SXP->CurWPosition];
...
//---------------button----------------
//#btn[%...](%...[...],{ref},"text")
static bool ADI_Btn( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* y1,
    int NActive, char** Active, int NParam, char** Param, char* /*param*/ )
{
...
//---------------standart button----------------
//#sbtn[%...](%...[...],{ref},"text")
static bool ADI_SBtn( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* y1,
    int NActive, char** Active, int NParam, char** Param, char* /*param*/ )
{
	if (NParam < 1)return false;
...
static void CHK_Process( sicExplorer* SXP, void* Data, int /*size*/ )
{
...
static bool ADI_Chk( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* /*x1*/, int* /*y1*/,
    int NActive, char** Active, int NParam, char** Param, char* /*param*/ )
{
...
static bool ADI_Rad( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* /*x1*/, int* /*y1*/,
    int NActive, char** Active, int NParam, char** Param, char* /*param*/ )
{
	if (NParam < 5)
		return false;
...
//------------------panel----------------
//#pan[%...](%...[...],"style")
static bool ADI_Pan( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* y1,
    int /*NActive*/, char** /*Active*/, int NParam, char** Param, char* /*param*/ )
{
...
//------------------panel----------------
//#apan[%...](%...[...],"style","text")
static bool ADI_APan( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* y1,
    int NActive, char** Active, int NParam, char** Param, char* /*param*/ )
{
	if (NParam < 1 || SXP->CurWPosition >= SXP->NWindows)return false;
	int sty = atoi( Param[0] );
...
static void SOR_Process( sicExplorer* SXP, void* Data, int /*size*/ )
{
...
static bool ADI_Sort( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* /*y1*/,
    int NActive, char** Active, int NParam, char** Param, char* /*param*/ )
{
...
static bool ADI_Poly( sicExplorer* /*SXP*/, DialogsSystem* DSS, int* x, int* y, int* x1, int* y1,
    int /*NActive*/, char** /*Active*/, int NParam, char** Param, char* /*param*/ )
{
...
static bool ADI_Stbl( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* y1,
    int NActive, char** Active, int NParam, char** Param, char* /*param*/ )
{
	if (NParam < 1)return false;
...
static int PXA[8] = { 37,38,39,40,41,42,44,43 };
static int PXP[8] = { 37 + 11,38 + 11,39 + 11,40 + 11,41 + 11,42 + 11,44 + 11,43 + 11 };

static void ShowPixString( sicExplorer* SXP, int x, int y, int x1, int Ly, RLCFont* F, char*s, bool Active )
{
	TempWindow TW;
	PushWindow( &TW );
...
static void Draw_DBTBL( int x, int y, int Lx, int Ly, int Index, byte Active, int param )
{
...
static void Process_DBTBL( sicExplorer* SXP, void* PData, int /*size*/ )
{
...
static void Close_DBTBL( sicExplorer* /*SXP*/, void* /*PData*/, int /*size*/ )
{}

static bool ADI_AddDBTBL( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* y1,
    int NActive, char** Active, int NParam, char** Param, char* /*param*/ )
{
	if (NActive < 2)
	{
...
static void ShowPixProcess( sicExplorer* /*SXP*/, void* PData, int /*size*/ )
{
...
static bool ADI_Pix( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* y1,
    int /*NActive*/, char** /*Active*/, int /*NParam*/, char** Param, char* param )
{
...
static bool ADI_Ubtn( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* /*x1*/, int* /*y1*/,
    int NActive, char** Active, int NParam, char** Param, char* /*param*/ )
{
...
//#gpbtn[%...](%...[...],{ref},"text")
static bool ADI_gpBtn( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* y1,
    int NActive, char** Active, int NParam, char** Param, char* /*param*/ )
{
	if (NParam < 1)return false;
...
static bool ADI_def_gp_btn( sicExplorer* SXP, DialogsSystem* /*DSS*/, int* /*x*/, int* /*y*/, int* /*x1*/, int* /*y1*/,
    int /*NActive*/, char** /*Active*/, int NParam, char** Param, char* /*param*/ )
{
	if (NParam < 1)return false;
	if (SXP->CurWPosition > SXP->NWindows)return true;
...
//--------------------Hint assignment---------------
//#hint(ID,"message")
static bool ADI_Hint( sicExplorer* SXP, DialogsSystem* /*DSS*/, int* /*x*/, int* /*y*/, int* /*x1*/, int* /*y1*/,
    int /*NActive*/, char** /*Active*/, int NParam, char** Param, char* /*param*/ )
{
	if (NParam < 2)
	{
...
//--------------Hint showing params-------------------
//#hintparam(%...[...],font)
static bool ADI_HintParam( sicExplorer* SXP, DialogsSystem* /*DSS*/, int* x, int* y, int* /*x1*/, int* /*y1*/,
    int /*NActive*/, char** /*Active*/, int NParam, char** Param, char* /*param*/ )
{
	if (NParam < 1)
	{
...
static bool ADI_Time( sicExplorer* SXP, DialogsSystem* /*DSS*/, int* /*x*/, int* /*y*/, int* /*x1*/, int* /*y1*/,
    int /*NActive*/, char** /*Active*/, int NParam, char** Param, char* /*param*/ )
{
...
//-----------------------------MAP CONTROL------------------------//
//#map[...](%...[...],{MAPID}{sendcom})
static void DrawMap( int x, int y, int Lx, int Ly, int /*Index*/, byte /*Active*/, int /*param*/ )
{
	BIGMAP.WX = x;
	BIGMAP.WY = y;
	BIGMAP.WLX = Lx;
...
static bool MapClick( SimpleDialog* SD )
{
...
static bool ADI_Map( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* y1,
    int NActive, char** Active, int /*NParam*/, char** /*Param*/, char* /*param*/ )
{
...
//#murl(Index,URL)
static bool ADI_murl( sicExplorer* /*SXP*/, DialogsSystem* /*DSS*/, int* /*x*/, int* /*y*/, int* /*x1*/, int* /*y1*/,
    int /*NActive*/, char** /*Active*/, int NParam, char** Param, char* /*param*/ )
{
	if (NParam < 2)return false;
...
static bool ADI_uurl( sicExplorer* /*SXP*/, DialogsSystem* /*DSS*/, int* /*x*/, int* /*y*/, int* /*x1*/, int* /*y1*/,
    int /*NActive*/, char** /*Active*/, int NParam, char** Param, char* /*param*/ )
{
	if (NParam < 2)return false;
	char URL[512];
...
//-------------------file downloader---------------------------
//#getf("server_ref")
static void sgetFile( sicExplorer* SXP, char* URL )
{
	char ccc[256];
...
static bool ADI_getf( sicExplorer* SXP, DialogsSystem* /*DSS*/, int* /*x*/, int* /*y*/, int* /*x1*/, int* /*y1*/,
    int /*NActive*/, char** /*Active*/, int NParam, char** Param, char* /*param*/ )
{
...
static bool ADI_ftxt( sicExplorer* SXP, DialogsSystem* DSS, int* x, int* y, int* x1, int* y1,
    int /*NActive*/, char** /*Active*/, int NParam, char** Param, char* /*param*/ )
{
	RLCFont* PFONT = SXP->GetFontByName( SXP->FONT1 );
	if (NParam < 1)return false;
...
static FBrowse* LastBrowse = nullptr;

static void SortStrings( char** strs, int nstr )
{
	bool change = 0;
	do
	{
...
static void EnumFilesInDirectory( char* Dir, char** mask, int NMasks, char* FrameID, char* BoxID );

static void FileClickProc( char** strs, int /*nstr*/ )
{
...
static void EnumFilesInDirectory( char* Dir, char** Mask, int NMasks, char* FrameID, char* BoxID )
{
	...
	fprintf( F, "<%s>\n", FrameID );
	int cstr = 0;
    const char* mask0 = "#txt[%%FDR0](%s[x:0,y:0,w:1000,h:1000],{LW_proc&%u&%s},\"{%s}\")\n";
    const char* mask = "#txt[%%FDR%d](%s[x:0,y:%%FDR%d,w:1000,h:1000],{LW_proc&%u&%s},\"{%s}\")\n";
    ...
    strcpy( GREQUEST, CCC );*/
    const char * TmpStr = "LW_file&Internet/Cash/tempcml_files.cml";
    GREQUEST = (char*) realloc( GREQUEST, strlen( TmpStr ) + 1 );
    strcpy( GREQUEST, TmpStr );

	REQSXP = LastBrowse->SXP;
}

static void BrowseChDisk( sicExplorer* SXP, void* /*PData*/, int /*size*/ )
{
...
static bool ADI_FBrowse( sicExplorer* SXP, DialogsSystem* /*DSS*/, int* /*x*/, int* /*y*/, int* /*x1*/, int* /*y1*/,
    int NActive, char** Active, int NParam, char** Param, char* /*param*/ )
{
...
static bool ADI_NewFont( sicExplorer* SXP, DialogsSystem* /*DSS*/, int* /*x*/, int* /*y*/, int* /*x1*/, int* /*y1*/,
    int /*NActive*/, char** /*Active*/, int NParam, char** Param, char* /*param*/ )
{
	if (NParam < 3)
	{
