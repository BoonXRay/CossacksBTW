...
//---------------------Using----------------------//
static Corners StdRect = { 0,2,6,8,12,14,9,11 };
static Corners LeftRect = { 0,-1,6,-1,12,-1,9,11 };
static Corners RightRect = { 1,2,7,8,13,14,9,11 };
static Corners UpTable = { 17,18,-1,-1,12,14,23,-1 };
static Corners UpTable1 = { 17,87,-1,-1,12,36,23,-1 };
static Corners DnTable1 = { 3,22,6,24,12,36,10,11 };
static Corners DnTable2 = { 3,86,6,8,12,14,10,11 };
static Corners Paper = { 43,44,45,46,49,50,47,48 };
static Corners HintPan = { 58,59,60,61,62,63,64,65 };
static Corners UpTable3 = { 0,2,-1,-1,12,14,9,-1 };
static Corners DnTable3 = { 3,5,6,8,12,14,10,11 };
static Corners HdrTbl = { 17,18,6,8,12,14,23,11 };

//Corners for the statistics panel
static Corners ST_Top = { 17,18,3,5,12,14,23,10 };

//Corners ST_Middle = { -1,-1,68,69,12,14,-1,70 }
//Corners ST_Bottom = { -1,-1,6,8,12,14,-1,11 }
static Corners ST_Middle = { 0,-1,68,69,12,14,-1,70 };//BUGFIX: -1 caused wrong coordinates
static Corners ST_Bottom = { 0,-1,6,8,12,14,-1,11 };

static Corners ST_Left = { 17,-1,6,-1,12,-1,23,11 };
static Corners ST_Right = { 23/*wrong!*/,18,7,8,13,14,23,11 };

//-----PALETTE 2---------//
static Corners P2_NORMAL = { 0,1,2,3,4,5,6,7 };
