...
uint8_t ResultMask[MaskLx*256];

static void CopyMaskedBitmap64( uint8_t * Bits,int x,int y,void* Mask){
	// BoonXRay 12.08.2017
	//__asm 
	{
		//push	esi
...
static void CopyMaskedTransparentBitmap_8( uint8_t * Bits,int x,int y,void* Mask)
{
    uint8_t nstr;
	// BoonXRay 12.08.2017
	//__asm 
...
static void CopyMaskedTransparentBitmap_4( uint8_t * Bits,int x,int y,void* Mask)
{
    uint8_t nstr;
	// BoonXRay 12.08.2017
	//__asm 
...
static void CopyMaskedTransparentBitmap_12( uint8_t * Bits,int x,int y,void* Mask){
    uint8_t nstr;
	// BoonXRay 12.08.2017
	//__asm
	{
...
static void CopyMaskedBitmap( uint8_t * Bits,int x,int y,int MaskID)
{
...
static void FastCreateMaskedBitmap64_1( uint8_t * Bits,int x,int y){
	int tmedi;
	// BoonXRay 12.08.2017
	//__asm 
	{
...
//    \  |
//      \|
static void FastCreateMaskedBitmap64_2( uint8_t * Bits,int x,int y){
	int tmedi;
	// BoonXRay 12.08.2017
	//__asm 
	{
