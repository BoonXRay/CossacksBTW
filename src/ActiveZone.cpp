...
static const char ZoneName[64] = "Zone1";
static const char GroupName[64] = "Group1";
static int CurrentZone = -1;
static int ZActionType = 0;

int CreateNewZone( const char* Name, int x, int y, int R )
{
...
void CreateNewActiveGroup( const char * gName )
{
...
void ActiveGroup::Draw(uint8_t c )
{
	MinX = 10000000;
	MinY = 10000000;
	MaxX = 0;
