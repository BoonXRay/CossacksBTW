...
static short fMap[MLX*MLX];

static int GetRand(int amp)
{
	return ((mrand()*amp) >> 14) - amp;
}

static int GetfMap(int x, int y)
{
	x &= MMSK;
	y &= MMSK;
...
static void SetfMap(int x, int y, int val)
{
...
static constexpr uint8_t scale = 32;
