...
static const unsigned int kMinimalProcessingInterval = 100;

static unsigned long last_hint_processing_time = 0;
...
static uint8_t HintOpt[kMaxHintCount];
