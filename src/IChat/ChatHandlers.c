...
** HANDLER DECS **
*****************/
static void ciPrivmsgHandler( CHAT chat, ciServerMessage * message );
static void ciNoticeHandler( CHAT chat, ciServerMessage * message );
static void ciUTMHandler( CHAT chat, ciServerMessage * message );
static void ciATMHandler( CHAT chat, ciServerMessage * message );
static void ciPingHandler( CHAT chat, ciServerMessage * message );
static void ciNickHandler( CHAT chat, ciServerMessage * message );
static void ciJoinHandler( CHAT chat, ciServerMessage * message );
static void ciPartHandler( CHAT chat, ciServerMessage * message );
static void ciKickHandler( CHAT chat, ciServerMessage * message );
static void ciQuitHandler( CHAT chat, ciServerMessage * message );
static void ciKillHandler( CHAT chat, ciServerMessage * message );
static void ciTopicHandler( CHAT chat, ciServerMessage * message );
static void ciModeHandler( CHAT chat, ciServerMessage * message );
static void ciErrorHandler( CHAT chat, ciServerMessage * message );
static void ciNameReplyHandler( CHAT chat, ciServerMessage * message );
static void ciEndOfNamesHandler( CHAT chat, ciServerMessage * message );
static void ciInviteHandler( CHAT chat, ciServerMessage * message );

static void ciRplTopicHandler( CHAT chat, ciServerMessage * message );
static void ciRplNoTopicHandler( CHAT chat, ciServerMessage * message );
static void ciErrNickInUseHandler( CHAT chat, ciServerMessage * message );
static void ciRplWhoReplyHandler( CHAT chat, ciServerMessage * message );
static void ciRplUserIPHandler( CHAT chat, ciServerMessage * message );
static void ciRplListStartHandler( CHAT chat, ciServerMessage * message );
static void ciRplListHandler( CHAT chat, ciServerMessage * message );
static void ciRplListEndHandler( CHAT chat, ciServerMessage * message );
static void ciRplChannelModeIsHandler( CHAT chat, ciServerMessage * message );
static void ciRplWhoisUserHandler( CHAT chat, ciServerMessage * message );
static void ciRplWhoisChannelsHandler( CHAT chat, ciServerMessage * message );
static void ciRplEndOfWhoisHandler( CHAT chat, ciServerMessage * message );
static void ciRplBanListHandler( CHAT chat, ciServerMessage * message );
static void ciRplEndOfBanListHandler( CHAT chat, ciServerMessage * message );
static void ciRplWelcomeHandler( CHAT chat, ciServerMessage * message );
static void ciRplEndOfWhoHandler( CHAT chat, ciServerMessage * message );
static void ciRplGetKeyHandler( CHAT chat, ciServerMessage * message );
static void ciRplEndGetKeyHandler( CHAT chat, ciServerMessage * message );
static void ciRplGetCKeyHandler( CHAT chat, ciServerMessage * message );
static void ciRplEndGetCKeyHandler( CHAT chat, ciServerMessage * message );
static void ciRplGetChanKeyHandler( CHAT chat, ciServerMessage * message );

static void ciErrNoSuchChannelHandler( CHAT chat, ciServerMessage * message );
static void ciErrTooManyChannelsHandler( CHAT chat, ciServerMessage * message );
static void ciErrChannelIsFullHandler( CHAT chat, ciServerMessage * message );
static void ciErrInviteOnlyChanHandler( CHAT chat, ciServerMessage * message );
static void ciErrBannedFromChanHandler( CHAT chat, ciServerMessage * message );
static void ciErrBadChannelKeyHandler( CHAT chat, ciServerMessage * message );
static void ciErrBadChanMaskHandler( CHAT chat, ciServerMessage * message );
static void ciErrNoSuchNickHandler( CHAT chat, ciServerMessage * message );
static void ciErrErroneusNicknameHandler( CHAT chat, ciServerMessage * message );
			...
			if (filter->type == matches[i].type)
			{
				...
				if (( !name && !filter->name ) || ( name && filter->name && ( strcasecmp( name, filter->name ) == 0 ) ))
				{
					if (( !name2 && !filter->name2 ) || ( name2 && filter->name2 && ( strcasecmp( name2, filter->name2 ) == 0 ) ))
					{
						...
						//////////////////////////////////////////////////////////////
                        filter->timeout = ( GetTickCount() + FILTER_TIMEOUT );
...
** NICK ERRORS **
****************/
static void ciNickError( CHAT chat, int type )
{
	CONNECTION;
