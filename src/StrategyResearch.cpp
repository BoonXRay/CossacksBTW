...
static const uint8_t StrCod[26] = { 0xFF,0xFF,0xFF,0xFF,0xFF,5,0xFF,0xFF,2,4,3,0,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0,1,2,2,0xFF,0xFF };

void GlobalArmyInfo::ResearchArmyDistribution(uint8_t NI)
{
#ifdef NOSTRATINF
	return;
#endif
