...
int GameConstants::GetValue(const char* Name) {
...
bool GameConstants::CheckDef(const char* Name)
{
	for (int i = 0; i < nnames; i++)
	{
...
char* GameConstants::GetString(const char* Name) {
	for (int i = 0; i < nsnames; i++) {
...
static GameConstants GConstant;
