...
uint8_t WeaponFlags[32];
short WeaponIcn[32];
short ProtectIcn[32];
int SGenIcon = 6;

static char* UnitKindID[64];
static int NUnitKinds;
...
int SDS_X = 8;
int SDS_Y = 2;
static int STAND_GRUND_ORDER_ICON = -1;
...
static short ForestFreq;
static short* ForestSounds;
static uint8_t NForestSounds = 0;

static short FieldFreq;
static short* FieldSounds;
static uint8_t NFieldSounds = 0;

static short SeaFreq;
static short* SeaSounds;
static byte NSeaSounds = 0;
...
static int xit[6] = { 126,531,382,257,663,793 };
...
static bool ReadFLine( GFILE* f, char* c )
{
	int s;
	bool eol;
	do
